...
def batch_export(context): 
    ...
    for obj in selection:
        ...
        bpy.ops.export_scene.fbx(filepath=fn + ".fbx", use_selection=True, global_scale=1, apply_scale_options='FBX_SCALE_NONE', axis_forward='Y', axis_up='Z', use_metadata=False)
